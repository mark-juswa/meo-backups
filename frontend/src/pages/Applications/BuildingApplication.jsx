            ...
            <div id="form-section-1" className={currentStep === 1 ? 'mb-8' : 'hidden'}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
                <div className="sm:col-span-2 lg:col-span-2">
                  ...
                  <input type="text" name="lastName" value={box1.owner.lastName} onChange={handleOwnerChange} className={`mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border ${errorClass('owner_last_name')}`} required />
                </div>
                <div className="sm:col-span-1">
                  <label className="block text-xs font-medium text-gray-700 mb-1">FIRST NAME</label>
                  <input type="text" name="firstName" value={box1.owner.firstName} onChange={handleOwnerChange} className={`mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border ${errorClass('owner_first_name')}`} required />
                </div>
                <div className="sm:col-span-1">
                  <label className="block text-xs font-medium text-gray-700 mb-1">M.I.</label>
                  <input type="text" name="middleInitial" value={box1.owner.middleInitial} onChange={handleOwnerChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" placeholder="M.I." />
                </div>
                <div className="sm:col-span-2 lg:col-span-4">
                  <label className="block text-xs font-medium text-gray-700 mb-1">TIN</label>
                  <input type="number" name="tin" value={box1.owner.tin} onChange={handleOwnerChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" placeholder="e.g. 123456789" />
                </div>
              </div>

              <h3 className="font-medium text-base sm:text-lg text-gray-700 mt-6 mb-3 border-t pt-4">For Construction Owned by an Enterprise</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6">
                ...
                <div className="sm:col-span-2 lg:col-span-1">
                  ...
                  <input type="text" name="projectTitle" value={box1.enterprise.projectTitle} onChange={handleEnterpriseChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                </div>

                <div className="sm:col-span-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
                  <div className="sm:col-span-1">
                    <label className="block text-xs font-medium text-gray-700 mb-1">ADDRESS: NO.</label>
                    <input type="number" name="no" value={box1.enterprise.address.no} onChange={handleEnterpriseAddressChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                  </div>
                  <div className="sm:col-span-1">
                    <label className="block text-xs font-medium text-gray-700 mb-1">STREET</label>
                    <input type="text" name="street" value={box1.enterprise.address.street} onChange={handleEnterpriseAddressChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                  </div>
                  <div className="sm:col-span-1">
                    <label className="block text-xs font-medium text-gray-700 mb-1">BARANGAY</label>
                    <input type="text" name="barangay" value={box1.enterprise.address.barangay} onChange={handleEnterpriseAddressChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                  </div>
                  <div className="sm:col-span-1">
                    <label className="block text-xs font-medium text-gray-700 mb-1">CITY / MUNICIPALITY</label>
                    <input type="text" name="city" value={box1.enterprise.address.city} onChange={handleEnterpriseAddressChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                  </div>
                  <div className="sm:col-span-1">
                    <label className="block text-xs font-medium text-gray-700 mb-1">ZIP CODE</label>
                    <input type="number" name="zip" value={box1.enterprise.address.zip} onChange={handleEnterpriseAddressChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                  </div>
                  <div className="sm:col-span-2 lg:col-span-5">
                    <label className="block text-xs font-medium text-gray-700 mb-1">TELEPHONE NO.</label>
                    <input type="number" name="telNo" value={box1.enterprise.address.telNo} onChange={handleEnterpriseAddressChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                  </div>
                </div>
              </div>

              <h3 className="font-medium text-base sm:text-lg text-gray-700 mt-6 mb-3 border-t pt-4">Location of Construction</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
                <div className="sm:col-span-1">
                  <label className="block text-xs font-medium text-gray-700 mb-1">LOT NO.</label>
                  <input type="text" name="lotNo" value={box1.location.lotNo} onChange={handleLocationChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                </div>
                <div className="sm:col-span-1">
                  <label className="block text-xs font-medium text-gray-700 mb-1">BLK NO.</label>
                  <input type="number" name="blkNo" value={box1.location.blkNo} onChange={handleLocationChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                </div>
                <div className="sm:col-span-1">
                  <label className="block text-xs font-medium text-gray-700 mb-1">TCT NO.</label>
                  <input type="number" name="tctNo" value={box1.location.tctNo} onChange={handleLocationChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                </div>
                <div className="sm:col-span-1">
                  <label className="block text-xs font-medium text-gray-700 mb-1">TAX DEC NO.</label>
                  <input type="number" name="taxDecNo" value={box1.location.taxDecNo} onChange={handleLocationChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                </div>

                <div className="sm:col-span-2 lg:col-span-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                  <div className="sm:col-span-1">
                    <label className="block text-xs font-medium text-gray-700 mb-1">STREET</label>
                    <input type="text" name="street" value={box1.location.street} onChange={handleLocationChange} className={`mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border ${errorClass('loc_street')}`} required />
                  </div>
                  <div className="sm:col-span-1">
                    <label className="block text-xs font-medium text-gray-700 mb-1">BARANGAY</label>
                    <input type="text" name="barangay" value={box1.location.barangay} onChange={handleLocationChange} className={`mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border ${errorClass('loc_barangay')}`} required />
                  </div>
                  <div className="sm:col-span-2">
                    <label className="block text-xs font-medium text-gray-700 mb-1">CITY / MUNICIPALITY OF</label>
                    <input type="text" name="city" value={box1.location.city} onChange={handleLocationChange} className={`mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border ${errorClass('loc_city')}`} required />
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 text-xs sm:text-sm">
                {[
                  ...
                  <label key={item.value} className="flex items-center p-2 rounded-md hover:bg-blue-50 cursor-pointer">
                    <input type="radio" name="group" value={item.value} onChange={handleOccupancyChange} checked={box1.occupancy.group === item.value} className="rounded-full text-blue-600 mr-2 flex-shrink-0" required />
                    <span className="truncate">{item.label}</span>
                  </label>
                ))}
              </div>
              <div className="mt-4 sm:mt-6">
                <input type="text" name="classified" value={box1.occupancy.classified} onChange={handleOccupancyChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" placeholder="Specify if OTHERS" disabled={box1.occupancy.group !== 'others'} />
              </div>

              <h3 className="font-medium text-base sm:text-lg text-gray-700 mt-6 mb-3 border-t pt-4">Project Details</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div className="sm:col-span-1">
                  <label className="block text-xs font-medium text-gray-700 mb-1">NO. OF UNITS</label>
                  <input type="number" name="numberOfUnits" value={box1.projectDetails.numberOfUnits} onChange={handleProjectDetailsChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" min="0" />
                </div>
                <div className="sm:col-span-1">
                  <label className="block text-xs font-medium text-gray-700 mb-1">COST (P)</label>
                  <input type="number" name="totalEstimatedCost" value={box1.projectDetails.totalEstimatedCost} onChange={handleProjectDetailsChange} className={`mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border ${errorClass('total_estimated_cost')}`} required />
                </div>
                <div className="sm:col-span-1">
                  <label className="block text-xs font-medium text-gray-700 mb-1">FLOOR AREA (m²)</label>
                  <input type="number" name="totalFloorArea" value={box1.projectDetails.totalFloorArea} onChange={handleProjectDetailsChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                </div>
                <div className="sm:col-span-1">
                  <label className="block text-xs font-medium text-gray-700 mb-1">LOT AREA (m²)</label>
                  <input type="number" name="lotArea" value={box1.projectDetails.lotArea} onChange={handleProjectDetailsChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                </div>
                <div className="sm:col-span-2">
                  <label className="block text-xs font-medium text-gray-700 mb-1">PROPOSED DATE</label>
                  <input type="date" name="proposedConstruction" value={box1.projectDetails.proposedConstruction} onChange={handleProjectDetailsChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                </div>
                <div className="sm:col-span-2">
                  <label className="block text-xs font-medium text-gray-700 mb-1">COMPLETION DATE</label>
                  <input type="date" name="expectedCompletion" value={box1.projectDetails.expectedCompletion} onChange={handleProjectDetailsChange} className="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md shadow-sm border border-gray-300" />
                </div>
              </div>
            </div>
